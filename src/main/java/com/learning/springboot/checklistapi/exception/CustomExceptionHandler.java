...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<Object> handleCategoryServiceException(CategoryServiceException ex) {
        log.error("An error happened to call API: " + ex.getMessage(), ex);
        return new ResponseEntity<>(new ExceptionalResponse(LocalDateTime.now(), ex.getMessage(),
