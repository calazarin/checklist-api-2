...
class CategoryServiceTest {
    ...
    @Test
    void shouldThrownAnExceptionWhenCategoryNameIsNullOrEmpty() {
        Exception exception =
    ...
    @Test
    void shouldThrownAnExceptionWhenTryToUpdateAndCategoryAndGuidIsNullOrEmpty() {
        Exception exception =
                Assertions.assertThrows(IllegalArgumentException.class, () ->
    ...
    @Test
    void shouldThrownAnExceptionWhenTryToUpdateAndCategoryAndNameIsNullOrEmpty() {
        Exception exception =
                Assertions.assertThrows(IllegalArgumentException.class, () ->
    ...
    @Test
    void shouldThrownAnExceptionWhenTryToUpdateAndCategoryAndItDoesNotExist() {
