...
class ChecklistItemControllerTest {
    ...
    @Test
    void shouldCallEndpointAndAddUpdateChecklistItemAndReturn204() throws Exception {
    ...
    @Test
    void shouldCallEndpointAndAddDeleteChecklistItemAndReturn204() throws Exception {
